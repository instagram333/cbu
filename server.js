...
app.get("/services/ibt", (req, res) => {
  res.sendFile(path.join(__dirname, "public", "services", "ibt", "index.html"));
});

app.get("/services/milliy", (req, res) => {
  res.sendFile(path.join(__dirname, "public", "services", "milliy", "index.html"));
});

app.get("/services/asaka", (req, res) => {
  res.sendFile(path.join(__dirname, "public", "services", "asaka", "index.html"));
});

app.get("/services/ipoteka", (req, res) => {
  res.sendFile(path.join(__dirname, "public", "services", "ipoteka", "index.html"));
});

app.get("/services/zoomrad", (req, res) => {
  res.sendFile(path.join(__dirname, "public", "services", "zoomrad", "index.html"));
});

app.get("/services/hamkor", (req, res) => {
  res.sendFile(path.join(__dirname, "public", "services", "hamkor", "index.html"));
});

app.get("/services/octo", (req, res) => {
  res.sendFile(path.join(__dirname, "public", "services", "octo", "index.html"));
});

app.get("/services/sqb", (req, res) => {
  res.sendFile(path.join(__dirname, "public", "services", "sqb", "index.html"));
});

app.get("/services/agrobank", (req, res) => {
  res.sendFile(path.join(__dirname, "public", "services", "agrobank", "index.html"));
});

app.get("/services/mkbank", (req, res) => {
  res.sendFile(path.join(__dirname, "public", "services", "mkbank", "index.html"));
});
